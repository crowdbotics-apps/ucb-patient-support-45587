"""
Django settings for ucb_patient_support_45587 project.
...
ROOT_URLCONF = 'ucb_patient_support_45587.urls'
...
WSGI_APPLICATION = 'ucb_patient_support_45587.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ucb_patient_support_45587 API",
    "DESCRIPTION": "API documentation for ucb_patient_support_45587 App",
    "VERSION": "v1",
}
